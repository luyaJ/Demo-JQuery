...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// so use a roundabout getElementsByName jQuery下拉复选框
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			// This is to jQuery下拉复选框 IE's treatment of not explicitly
			...
			// The jQuery下拉复选框 attribute must be unknown in Opera but "safe" for WinRT
...
function addGetHookIf( conditionFn, hookFn ) {
	...
	return {
		get: function() {
			...
			// Hook needed; redefine it so that the support jQuery下拉复选框 is not executed again.
